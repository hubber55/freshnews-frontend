    ...
    <div className="mt-8 border-t border-[#373737] pt-6">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 rounded-lg bg-[#25d366] px-5 py-3 text-sm font-semibold text-white shadow-md transition-all hover:brightness-110 hover:shadow-lg active:scale-95"
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-lg bg-[#383838] px-5 py-3 text-sm font-semibold text-white shadow-md transition-all hover:bg-[#454545] hover:shadow-lg active:scale-95"
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-lg bg-[#ff6a00] px-5 py-3 text-sm font-semibold text-white shadow-md transition-all hover:brightness-110 hover:shadow-lg active:scale-95"
