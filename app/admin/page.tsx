...
import { FileText, Tag, Settings, HelpCircle } from 'lucide-react';
  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Link href="/admin/posts" className="block p-6 rounded-xl bg-[var(--bg-card)] border border-[var(--border)] hover:border-[#ffd42a]/50 transition-all">
          <div className="flex items-center gap-3 mb-3">
            <div className="p-2 rounded-lg bg-[#ffd42a]/10">
              <FileText size={24} className="text-[#ffd42a]" />
            </div>
            <h2 className="text-xl font-bold text-white">Manage Posts</h2>
          </div>
          <p className="text-[var(--text-muted)]">View, edit, and approve submissions.</p>
        </Link>
