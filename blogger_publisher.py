...
class BloggerQuotaExhausted(Exception):
    """Raised when Blogger API returns 429 quota exhausted."""
    pass
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if response.status_code == 429:
                logger.warning("  🚨 GOOGLE BLOGGER QUOTA HIT! Raising QuotaExhausted.")
                raise BloggerQuotaExhausted(response.text[:200])
            return False
